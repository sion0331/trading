...
if __name__ == "__main__":
    # sym = "EUR"
    # RAW_PAIRS = ["EURUSD","USDCHF", "CHFUSD", "USDHKD", "USDJPY", "USDAED", "USDBGN", "USDBHD", "USDCAD", "USDCNH", "USDCZK",
    # "USDDKK", "USDHUF", "USDIDR", "IDRUSD"]
    RAW_PAIRS = ["USDKWD", "USDMXN", "USDNOK", "USDOMR", "USDPLN", "USDRON", "USDSAR", "USDSEK", "USDSGD", "USDTRY",
                 "USDZAR"]
    # "USDILS", "KRWUSD"

    sd = datetime(2025, 9, 2, tzinfo=pytz.UTC)
    ...
    try:
        for pair in RAW_PAIRS:
            download(ib, pair, sd, ed, page=1000, step_s=60, empty_step_s=300)  # e.g., jump 5m on empty pages
    finally:
        ib.disconnect()
